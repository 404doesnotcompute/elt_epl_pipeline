...
def ingest_and_store_all_players_raw(api,s3,team_ids):
    """
    ...
    for team_id in team_ids:
        try:
            player_df = api.fetch("epl/v1/teams", team_id=team_id, subresource="players")
        ...
        # time.sleep(15)  # uncomment obey free-tier API limit    
